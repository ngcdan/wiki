...
![Tạo hóa đơn điện tử mới - Trang 3](../attachments/bf1-bfs/accounting/acct_03.png)

![Tạo hóa đơn - Trang 4](../attachments/bf1-bfs/accounting/acct_04.png)

![Tạo hóa đơn kèm bảng kê - Trang 5](../attachments/bf1-bfs/accounting/acct_05.png)
...
![Print Preview - Trang 6](../attachments/bf1-bfs/accounting/acct_06.png)
...
![Issue E-Invoice - Trang 7](../attachments/bf1-bfs/accounting/acct_07.png)

- **Send E-Invoice by mail:** Gửi mail có file PDF và file mã hóa XML cho khách hàng với điều kiện hóa đơn đã issue.

![Send E-Invoice by mail - Trang 8](../attachments/bf1-bfs/accounting/acct_08.png)
...
![Replace New E-Invoice - Trang 9](../attachments/bf1-bfs/accounting/acct_09.png)

![Replace New E-Invoice chi tiết - Trang 10](../attachments/bf1-bfs/accounting/acct_10.png)
...
![Make Editing Invoice - Trang 11](../attachments/bf1-bfs/accounting/acct_11.png)
...
![Attach file - Trang 12](../attachments/bf1-bfs/accounting/acct_12.png)
...
![Import và Make payment - Trang 13](../attachments/bf1-bfs/accounting/acct_13.png)
...
![Clear Docs - Trang 15](../attachments/bf1-bfs/accounting/acct_15.png)
...
![Ký hàng loạt - Trang 16](../attachments/bf1-bfs/accounting/acct_16.png)
...
![VAT Invoice Management - Trang 16](../attachments/bf1-bfs/accounting/acct_16.png)
...
![Xem chi tiết hóa đơn - Trang 17](../attachments/bf1-bfs/accounting/acct_17.png)
...
![Các trạng thái hóa đơn - Trang 18](../attachments/bf1-bfs/accounting/acct_18.png)

### b. Các công cụ

**Get Invoice Temp:** Xem hóa đơn đang tạo có người sử dụng hay chưa.

![Get Invoice Temp - Trang 19](../attachments/bf1-bfs/accounting/acct_19.png)
...
![Accounting Management - Trang 20](../attachments/bf1-bfs/accounting/acct_20.png)

![Accounting Management chi tiết - Trang 21](../attachments/bf1-bfs/accounting/acct_21.png)
...
![Transaction Register - Trang 27](../attachments/bf1-bfs/accounting/acct_27.png)
...
![Advance Request - Trang 30](../attachments/bf1-bfs/accounting/acct_30.png)
...
![Advance Payment - Trang 30](../attachments/bf1-bfs/accounting/acct_30.png)

![Advance Payment chi tiết - Trang 31](../attachments/bf1-bfs/accounting/acct_31.png)
...
![Settlement - Trang 39](../attachments/bf1-bfs/accounting/acct_39.png)
...
![Payment Request Control - Trang 40](../attachments/bf1-bfs/accounting/acct_40.png)

![Payment Request Control chi tiết - Trang 41](../attachments/bf1-bfs/accounting/acct_41.png)
...
![Shipment Payment Control - Trang 42](../attachments/bf1-bfs/accounting/acct_42.png)

![Shipment Payment Control chi tiết - Trang 44](../attachments/bf1-bfs/accounting/acct_44.png)
...
![Credit Invoice Report - Trang 45](../attachments/bf1-bfs/accounting/acct_45.png)

![Credit Note Import - Trang 46](../attachments/bf1-bfs/accounting/acct_46.png)
...
![Sheet of Debit Record - Trang 47](../attachments/bf1-bfs/accounting/acct_47.png)
...
![Payment Sheet Example - Trang 48](../attachments/bf1-bfs/accounting/acct_48.png)
...
![Job Costing Summary - Trang 48](../attachments/bf1-bfs/accounting/acct_48.png)

Hoặc ta có thể sắp xếp dữ liệu theo trường tương ứng ta muốn bằng cách click chuột vào trường cần chọn, kéo và thả trường đó vào phía bên trên của bảng. Hệ thống sẽ tự động sắp xếp dữ liệu theo trường tương ứng phía bên trên.

![Job Costing Example - Trang 49](../attachments/bf1-bfs/accounting/acct_49.png)

- **Account Payable:** Gọi dữ liệu các khoản phải trả. Bảng được sắp xếp dữ liệu ưu tiên theo trường thông tin Company Name.

![Account Payable - Trang 49](../attachments/bf1-bfs/accounting/acct_49.png)

Hoặc ta có thể sắp xếp dữ liệu theo trường tương ứng ta muốn bằng cách click chuột vào trường cần chọn, kéo và thả trường đó vào phía bên trên của bảng. Hệ thống sẽ tự động sắp xếp dữ liệu theo trường tương ứng phía bên trên.

![Account Payable Example - Trang 50](../attachments/bf1-bfs/accounting/acct_50.png)
...
![Account Receivable - Trang 50](../attachments/bf1-bfs/accounting/acct_50.png)

Hoặc ta có thể sắp xếp dữ liệu theo trường tương ứng ta muốn bằng cách click chuột vào trường cần chọn, kéo và thả trường đó vào phía bên trên của bảng. Hệ thống sẽ tự động sắp xếp dữ liệu theo trường tương ứng phía bên trên.

![Account Receivable Example - Trang 51](../attachments/bf1-bfs/accounting/acct_51.png)

- **Kick Back Report:** Bản báo cáo tiền hoa hồng. Bảng được sắp xếp dữ liệu ưu tiên theo trường thông tin Partner Name.

![Kick Back Report - Trang 51](../attachments/bf1-bfs/accounting/acct_51.png)

Hoặc ta có thể sắp xếp dữ liệu theo trường tương ứng ta muốn bằng cách click chuột vào trường cần chọn, kéo và thả trường đó vào phía bên trên của bảng. Hệ thống sẽ tự động sắp xếp dữ liệu theo trường tương ứng phía bên trên.

![Kick Back Example - Trang 52](../attachments/bf1-bfs/accounting/acct_52.png)

- **Aging Report:** Bản báo cáo tuổi nợ.

- **Profit Report:** Bản báo cáo lợi nhuận (P/L).

![Profit Report - Trang 52](../attachments/bf1-bfs/accounting/acct_52.png)
...
![Profit Report Example - Trang 53](../attachments/bf1-bfs/accounting/acct_53.png)

- **Logistics Receivable:** Form công nợ riêng cho khách hàng đặc biệt.

![Logistics Receivable - Trang 53](../attachments/bf1-bfs/accounting/acct_53.png)

Ta có thể sắp xếp dữ liệu theo trường tương ứng ta muốn bằng cách click chuột vào trường cần chọn, kéo và thả trường đó vào phía bên trên của bảng. Hệ thống sẽ tự động sắp xếp dữ liệu theo trường tương ứng phía bên trên.

![Logistics Receivable Example - Trang 54](../attachments/bf1-bfs/accounting/acct_54.png)

- **Debit Template 01 (KUANGTAI):** Form công nợ riêng cho khách hàng đặc biệt.

![Debit Template - Trang 54](../attachments/bf1-bfs/accounting/acct_54.png)
...
![VAT Invoice Report - Trang 55](../attachments/bf1-bfs/accounting/acct_55.png)
...
![VAT Invoice Status - Trang 56](../attachments/bf1-bfs/accounting/acct_56.png)
...
![VAT Bank Information - Trang 57](../attachments/bf1-bfs/accounting/acct_57.png)
...
![Account Old Debit - Trang 58](../attachments/bf1-bfs/accounting/acct_58.png)
...
![Account Old Debit Filtered - Trang 59](../attachments/bf1-bfs/accounting/acct_59.png)
...
![Account Old Debit Send Mail - Trang 60](../attachments/bf1-bfs/accounting/acct_60.png)
...
![Account Receivable - Trang 60](../attachments/bf1-bfs/accounting/acct_60.png)
...
![Overdue Debts - Trang 61](../attachments/bf1-bfs/accounting/acct_61.png)
...
![Overdue Debts Warning - Trang 62](../attachments/bf1-bfs/accounting/acct_62.png)
...
![Hạn mức công nợ - Trang 63](../attachments/bf1-bfs/accounting/acct_63.png)
...
![Hạn mức thông báo - Trang 64](../attachments/bf1-bfs/accounting/acct_64.png)
...
![Yêu cầu duyệt bảo lãnh - Trang 64](../attachments/bf1-bfs/accounting/acct_64.png)
...
![Gửi yêu cầu duyệt - Trang 65](../attachments/bf1-bfs/accounting/acct_65.png)
...
![View to approve - Trang 65](../attachments/bf1-bfs/accounting/acct_65.png)

Và lúc này sẽ xuất hiện màn hình để duyệt. Bấm vào nút Approve để duyệt.

![Approve HBL - Trang 66](../attachments/bf1-bfs/accounting/acct_66.png)
...
![Debit Note New - Trang 66](../attachments/bf1-bfs/accounting/acct_66.png)
...
![Debit Note Status - Trang 67](../attachments/bf1-bfs/accounting/acct_67.png)
...
![Invoice for Account Payable - Trang 68](../attachments/bf1-bfs/accounting/acct_68.png)
...
![Invoice Status - Trang 69](../attachments/bf1-bfs/accounting/acct_69.png)
...
![Edit Invoice - Trang 70](../attachments/bf1-bfs/accounting/acct_70.png)
...
![Import Costing - Trang 70](../attachments/bf1-bfs/accounting/acct_70.png)
...
![Import Status - Trang 71](../attachments/bf1-bfs/accounting/acct_71.png)
...
![OBH Debit Note - Trang 72](../attachments/bf1-bfs/accounting/acct_72.png)
...
![OBH Debit Note Details - Trang 73](../attachments/bf1-bfs/accounting/acct_73.png)
...
![Credit Note Other - Trang 73](../attachments/bf1-bfs/accounting/acct_73.png)
...
![Credit Note Form - Trang 74](../attachments/bf1-bfs/accounting/acct_74.png)
...
![Financial Planning - Trang 75](../attachments/bf1-bfs/accounting/acct_75.png)
...
![Bank Transaction History - Trang 76](../attachments/bf1-bfs/accounting/acct_76.png)
...
![Make Finish - Trang 77](../attachments/bf1-bfs/accounting/acct_77.png)
