...
### Truy vấn dữ liệu thay đổi

SQL Server tạo schema cdc, để truy vấn dữ liệu thay đổi:
...
## Khi bật CDC cho một bảng

- SQL Server tạo ra một bảng thay đổi (change table) trong schema cdc (ví dụ `cdc.dbo_Partners_CT`)
